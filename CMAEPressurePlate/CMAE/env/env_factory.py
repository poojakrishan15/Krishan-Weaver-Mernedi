...
from env.environment import PressurePlate
...
ENV_MAP = {
    ...
    'pressure_plate': functools.partial(PressurePlate, H=300, height=15, width=9, sensor_range=4, layout='linear', n_agents=4)
}
