...
def obs_to_int_pi(obs, base, raw_dim):
    # if raw_dim == 4:
    #     return obs[0] * base**3 + obs[1] * base**2 + obs[2] * base**3 + obs[3] * base**2 + obs[3], \
    #            obs[2] * base**3 + obs[3] * base**2 + obs[3] * base**2 + obs[0] * base + obs[1]
    if raw_dim == 5:
        return obs[4] * base**4 + obs[0] * base**3 + obs[1] * base**2 + obs[2] * base + obs[3], obs[4] * base**4 + obs[2] * base**3 + obs[3] * base**2 + obs[0] * base + obs[1]
    elif raw_dim == 6:
