...
python main.py --env push_box --exp_mode epsilon --multilevel --tree_subspace  --stochastic_select_subspace --alpha1 0.1 --alpha2 0.05  --exp_name ${EXP} --seed ${i} --exp_batch_name ${EXP_BATCH_NAME}
